...
public class LinkedList {
    ...
    public static void main(String args[]) {
        ...
        linkedList.insertNode("일");
        linkedList.insertNode("월");
        linkedList.insertNode("화");
        linkedList.insertNode("수");
        linkedList.insertNode("목");
        linkedList.insertNode("금");
        linkedList.insertNode("토");
